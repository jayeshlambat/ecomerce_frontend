...
function Adminpage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://ecomerse-backend.onrender.com/api/admin/addproduct", formData, {
                headers: {
                    'content-type': "multipart/form-data"
                }
            });
            console.log("Response Data:", response.data.productData);
            setproductData({
                title: "",
                cateogery: "",
                description: "",
    ...
    console.log("from admin resproductdata", resproductData);
