...
function Signin() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://ecomerse-backend.onrender.com/api/signin', {
                method: "POST",
                headers: {
        ...
        <div className='mainDiv'>
            ...
            <div className='right'>
                ...
                <div className='signup'>
                    <h1>Sign in</h1>
                    <p>Donot have an account yet? <Link to='/'>Sign up</Link> </p>
                </div>
                ...
                <div className="xtralogin">
                    ...
                    <p className='admin' > <Link to='/bussinesslogin'> Bussiness Login</Link>  </p>
                </div>
            </div>
